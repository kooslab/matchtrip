# MatchTrip Platform Encryption Guide
...
1. [Core Encryption Standard](#core-encryption-standard)
2. [Email Encryption with Hash-Based Lookups](#email-encryption-with-hash-based-lookups)
3. [Implementation Guide](#implementation-guide)
4. [Security & Best Practices](#security--best-practices)
5. [Migration & Recovery](#migration--recovery)
...
# OAuth credentials (for testing email encryption)
GOOGLE_CLIENT_ID=...
...
8. **NEVER expose encrypted data** to the client
...
8. **Decrypt data server-side only** when absolutely necessary
...
1. **Decrypt data** (if you have the encryption key):

   ```typescript
   // Update all users to decrypt data
