...
{#if isOpen}
	...
	>
		...
		<div class="flex min-h-screen items-center justify-center p-4">
			<!-- Modal Content -->
			<div 
				class="relative w-full max-w-md max-h-[80vh] rounded-2xl bg-white shadow-xl flex flex-col"
				...
				<div class="flex-1 overflow-y-auto px-6 py-4">
					{#if type === 'terms'}
						<div class="space-y-4 text-sm text-gray-700">
							...
							<p>
								이 약관은 매치트립(이하 "회사")이 운영하는 매치트립 서비스(이하 "서비스")를 이용함에 있어 
								회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
							</p>

							<h3 class="font-bold">제2조 (정의)</h3>
							<p>
								1. "서비스"란 회사가 제공하는 여행자와 현지 가이드를 연결하는 플랫폼 서비스를 의미합니다.<br>
								2. "회원"이란 이 약관에 따라 회사와 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 고객을 말합니다.<br>
					...
					{:else if type === 'marketing'}
						<div class="space-y-4 text-sm text-gray-700">
							...
							<p>
								매치트립은 회원님께 보다 나은 서비스를 제공하기 위해 다음과 같은 정보를 전달해드리고자 합니다.
							</p>
							...
							<p>
								이메일, SMS, 앱 푸시 알림 등을 통해 정보를 전달합니다.
							</p>

							<h3 class="font-bold">3. 수신 동의 철회</h3>
							<p>
								마케팅 정보 수신에 동의하신 후에도 언제든지 수신을 거부하실 수 있습니다. 
								수신 거부는 서비스 내 설정 메뉴 또는 수신한 마케팅 정보 내 수신거부 링크를 통해 가능합니다.
							</p>

							<h3 class="font-bold">4. 개인정보 보호</h3>
							<p>
								회사는 회원님의 개인정보를 소중히 다루며, 마케팅 정보 발송 외의 목적으로는 사용하지 않습니다. 
