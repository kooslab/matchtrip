<script lang="ts">
	...
	function canProceed() {
		switch (currentStep) {
			case 1:
				return offerData.pricePerPerson.trim() !== '';
			case 2:
				return offerData.description.trim() !== '';
			case 3:
...
{#if currentStep < 5}
	<div class="min-h-screen bg-gray-50">
		...
		<div class="flex-1 px-4 py-6 pb-24">
			{#if currentStep === 1}
				...
				<div class="space-y-6">
					...
					<div class="space-y-3">
						<label class="block text-sm font-medium text-gray-700"> 1인당 가격 </label>
						<input
							type="number"
			...
			{:else if currentStep === 2}
				...
				<div class="space-y-6">
					...
					<div class="space-y-4">
						<div>
							<label class="mb-2 block text-sm font-medium text-gray-700"> 제안 내용 </label>
							<textarea
						...
						{#each offerData.itinerary as day, index}
							<button
								...
								class="rounded-lg px-4 py-2 text-sm font-medium transition-colors
									{selectedDay === day.day ? 'text-white' : 'bg-gray-100 text-gray-700'}"
							...
							<div class="space-y-4">
								<div>
									...
									<input
										...
										class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:ring-1 focus:outline-none"
										style="--tw-ring-color: {colors.primary}; --tw-border-opacity: 1;"
										onfocus={(e) => (e.target.style.borderColor = colors.primary)}
										onblur={(e) => (e.target.style.borderColor = '')}
									/>
								...
								<div>
									<label class="mb-2 block text-sm font-medium text-gray-700"> 일정 시간 </label>
									<input
										type="text"
								...
								<div>
									<label class="mb-2 block text-sm font-medium text-gray-700"> 일정 제목 </label>
									<input
										type="text"
								...
								<div>
									<label class="mb-2 block text-sm font-medium text-gray-700"> 일정 내용 </label>
									<input
										type="text"
			...
			{:else if currentStep === 4}
				...
				<div class="space-y-6">
					...
					<div class="space-y-4">
						<div>
							<label class="mb-2 block text-sm font-medium text-gray-700"> 첨부 파일 </label>
							...
							<label class="block">
								...
								/>
								<div
									class="flex h-48 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 transition-colors hover:border-gray-400"
								>
									<svg
									...
									<p class="text-sm font-medium text-gray-600">파일을 클릭하여 찾아보세요.</p>
		...
		<!-- Bottom Button -->
		<div class="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white px-4 py-4 pb-4">
			{#if currentStep === 4}
				<button
...
{:else}
	...
	<div class="flex min-h-screen flex-col items-center justify-center bg-white px-4">
		...
		<!-- Bottom button -->
		<div class="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] px-4 py-4 pb-4">
			<button
				onclick={goToHome}
				class="w-full rounded-lg py-3.5 text-base font-semibold text-white transition-all"
				style="background-color: {colors.primary}"
