	...
	>
		...
		>
			...
			<div class="relative w-full shrink-0">
				<div
					class="pointer-events-none absolute top-0 right-0 bottom-[-4px] left-0 border-solid border-[#f7f9fa] border-[0px_0px_4px]"
				/>
			...
			<div class="relative w-full shrink-0 bg-[#ffffff]">
				...
				<div class="relative size-full">
					...
					>
						...
						>
							<div
								class="pointer-events-none absolute inset-0 border-solid border-[#f1f1f1] border-[0px_0px_1px]"
							/>
							<div
