		...
		<div>
			...
			<div class="relative">
				<input
					...
					class="w-full border-b border-gray-300 px-4 py-3 pr-12 text-right text-lg focus:border-blue-500 focus:outline-none"
				/>
				<span class="absolute top-1/2 right-4 -translate-y-1/2 text-lg text-gray-500">원</span>
			</div>
		</div>
	</div>
