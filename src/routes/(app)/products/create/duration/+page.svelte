...
<div class="flex-1 bg-white p-4">
	...
	<div class="space-y-6">
		<!-- Duration Input -->
		<div>
			<label class="mb-2 block text-sm font-medium text-gray-700"> 투어 시간 </label>
			<div class="relative">
				<input
					type="text"
					inputmode="numeric"
					...
					class="w-full border-b border-gray-300 px-4 py-3 pr-16 text-right text-lg focus:border-blue-500 focus:outline-none disabled:bg-gray-50 disabled:text-gray-400"
				/>
				<span class="absolute top-1/2 right-4 -translate-y-1/2 text-lg text-gray-500">시간</span>
			</div>
		</div>
	...
	<!-- Submit Button -->
	<div class="fixed right-0 bottom-0 left-0 bg-white p-4">
