...
>
	...
	<div class="flex w-full max-w-xs flex-col gap-4">
		<h1 class="mb-4 text-center text-2xl font-bold text-gray-800">로그인</h1>
		<button
			type="button"
			onclick={handleGoogleSignIn}
			disabled={isLoading}
			class="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
		>
